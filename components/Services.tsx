        ...
        <div id="about" className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20 scroll-mt-32">
          <div className="md:col-span-5">
             <div className="aspect-video bg-zinc-900 rounded-lg overflow-hidden">
                <img src="https://images.unsplash.com/photo-1509319117193-42d427418604?q=80&w=800&auto=format&fit=crop" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" alt="Designer working" />
             </div>
          </div>
